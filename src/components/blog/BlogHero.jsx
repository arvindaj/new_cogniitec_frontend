...
const BlogHero = () => {
    return (
        <div className="w-full bg-[#F6F2EB] py-16 px-4 flex flex-col items-center">
            {/* Title */}
            ...
            <div className="w-full max-w-5xl overflow-hidden rounded-lg">
                ...
                {/* Blog Title */}
                <h1 className="mt-6 text-2xl md:text-2xl font-semibold text-black text-start md:text-left max-w-5xl">
