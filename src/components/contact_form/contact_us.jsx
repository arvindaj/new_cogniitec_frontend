      ...
      <div className="max-w-8xl mx-auto font-poppins">
        <div className="flex flex-col md:flex-row justify-between mb-12 gap-8">
          <div className="flex-1">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-black leading-tight mb-2">
        ...
        <form className="w-full space-y-8">
          ...
          <div className="flex flex-col">
            ...
            //   placeholder="Type your message here..."
              className="border-b border-gray-300 focus:border-black outline-none py-2 text-gray-800 placeholder-gray-400 resize-none rounded-2xl"
            ></textarea>
          </div>
